...
/**
 * DropdownMenu Root: Quản lý trạng thái đóng/mở của menu.
 */
...
/**
 * DropdownMenuContent: Panel chứa các mục menu chính.
 * Có xử lý hướng xuất hiện (sideOffset) và animation mượt mà.
 */
...
/**
 * DropdownMenuItem: Mục menu đơn lẻ.
 * Hỗ trợ variant 'destructive' cho các tác vụ nguy hiểm.
 */
