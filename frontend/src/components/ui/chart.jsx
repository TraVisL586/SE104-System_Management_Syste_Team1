...
// Định nghĩa selector cho các theme
...
/**
 * Container chính bọc ngoài biểu đồ, khởi tạo Context và ResponsiveContainer
 */
    ...
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        className={cn(
          ...
          // Các class bổ trợ để style trực tiếp vào SVG của Recharts bằng Tailwind
...
/**
 * Component nội bộ tạo ra thẻ <style> để chuyển đổi config màu sắc thành biến CSS
 */
...
/**
 * Custom Tooltip với khả năng hiển thị Indicator (dot, line, dashed) và màu sắc từ config
 */
...
/**
 * Custom Legend hiển thị icon hoặc dot màu sắc tương ứng
 */
...
/**
 * Helper: Trích xuất cấu hình từ payload của Recharts
 */
